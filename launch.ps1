...
New-CFNStack -StackName $Stackname -TemplateBody $templatebody -StoredCredentials $StoredCred -Region $region

Start-Sleep -s 300

$CFNStack = Get-CFNStack -StackName $Stackname -StoredCredentials $StoredCred -Region $region
